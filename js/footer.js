                        ...
                        <div class="grid md:grid-cols-3 gap-5 space-y-5 md:space-y-0">
                            ...
                            <div
                                ...
                                <div class="text-sm flex flex-col space-y-3">
                                    ...
                                    <a href="tel:+1(720)2611132"><i class="fa fa-phone-alt mr-3"></i>+1 (720)
                                        261
                                        1132</a>
                                    <a href="mailto:info@myerphub.com"><i
                            ...
                            <div
                                ...
                                <div class="text-sm flex flex-col space-y-3">
                                    ...
                                    <a href="tel:+919395191219"><i class="fa fa-phone-alt mr-3"></i>+91 93951
                                        91219</a>
                                    <a href="mailto:info@myerphub.com"><i
                                            class="fa fa-envelope mr-3"></i>info@myerphub.com</a>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        <div>
                            ...
                            <div class="flex space-x-4">
                                <a href="https://www.facebook.com/profile.php?id=61568692711977" target="_blank"
                                    class="text-gray-400 hover:text-white"><i class="fab fa-facebook-f"></i></a>
                                <a href="https://www.youtube.com/@sapficohub" target="_blank"
                                    class="text-gray-400 hover:text-white"><i class="fab fa-youtube"></i></a>
                                <!-- <a href="#" class="text-gray-400 hover:text-white"><i class="fab fa-linkedin-in"></i></a> -->
                                <a href="https://www.instagram.com/erp_hub/" target="_blank"
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                ...
                                <li><a href="./blogs.html" class="text-gray-400 hover:text-white">Blogs</a></li>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-center">
                                    <a href="tel:9876543210" target="_blank" class="text-gray-400 hover:text-white">
                                        <i class="fas fa-phone-alt text-blue-500 mr-3"></i>
                                        <span>+91 98765 43210</span>
                                    </a>
                                </li>
                                <li class="flex items-center">
                                    <a href="mailto:info@myerphub.com" class="text-gray-400 hover:text-white">
                                        <i class="fas fa-envelope text-blue-500 mr-3"></i>
                                        <span>info@myerphub.com</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
